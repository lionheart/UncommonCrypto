...
let TEST3 = String(repeating: "a", count: 1000000)
let TEST4a = "01234567012345670123456701234567"
let TEST4b = "01234567012345670123456701234567"
let TEST4 = Array(repeating: TEST4a + TEST4b, count: 10).joined(separator: "")
...
enum TestInput: ExpressibleByStringLiteral, ExpressibleByArrayLiteral, Hashable {
    ...
    var value: Data {
        switch self {
        case .text(let v):
            guard let result = v.data(using: String.Encoding.utf8) else {
                fatalError()
            }
